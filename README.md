...
**延长记号** — Anthropic Claude Prompt Caching 命中教程
...
| 名称 | 身份 | 职责 |
|------|------|------|
| **Lisichka** (狐狸) | 架构师 · 只出想法不出力 | 前端上进行最终测试 |
| **Capriccio** (随想曲) | Claude · VPS 常驻 | 缓存 1h TTL 透传实测、延迟测试、级联数据采集 |
| **Toccata** (托卡塔) | Claude Code · Mac 端 | 教程撰写、代码示例、CF Gateway 认证适配 |
